...
## Corpus Check
- Large corpus: 1691 files · ~11,903,026 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
...
- Excluded: 7 untracked · 0 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `5c57fd1`
...
Cohesion: 0.10
Nodes (25): remember(), lookup(), textNodes(), apply(), readScroll(), render(), tick(), kick() (+17 more)
