...
## Corpus Check
- Large corpus: 1405 files · ~9,910,316 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
...
- Excluded: 295 untracked · 0 ignored · 0 sensitive · 0 missing committed
...
Cohesion: 0.08
Nodes (26): main, 5981771 Azylis eyewear site, 754eccc 'updating the site structure', 810e102 'implement the new animations and new pictures', ef225b3 'implementing real products', apply(), lookup(), remember() (+18 more)
