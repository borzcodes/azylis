...
(function () {
  ...
  var T = {
    ...
    "Acetate frame with UV400 lenses, fitted and adjusted at the studio in Casablanca.":
      ["Monture en acétate et verres UV400, ajustée à l'atelier de Casablanca.",
       "إطار من الأسيتات مع عدسات UV400، يُضبط في أتيليه الدار البيضاء.",
       "Montura de acetato con lentes UV400, ajustada en el taller de Casablanca."],
    "Every pair is checked and adjusted by hand before it leaves the studio — hinges tightened, temples shaped to sit level. Cash on delivery across Morocco, and a free adjustment in store whenever you need one.":
      ["Chaque paire est vérifiée et ajustée à la main avant de quitter l'atelier : charnières resserrées, branches formées pour tomber droit. Paiement à la livraison partout au Maroc, et un réglage gratuit en boutique quand vous en avez besoin.",
       "يُفحص كل زوج ويُضبط يدويًا قبل مغادرة الأتيليه: تُشدّ المفصلات وتُشكَّل الأذرع لتستقر باستواء. الدفع عند الاستلام في كل المغرب، وضبط مجاني في المتجر متى احتجت إليه.",
       "Cada par se revisa y ajusta a mano antes de salir del taller: bisagras apretadas, varillas moldeadas para asentar rectas. Pago contra reembolso en todo Marruecos y un ajuste gratuito en tienda cuando lo necesites."],
    ...
    "Seen in Azylis": ["Vu en Azylis", "بنظارات أزيليس", "Visto en Azylis"],
    "Spotted in the studio": ["Aperçu à l'atelier", "شوهد في الأتيليه", "Visto en el taller"],
    ...
    "A familiar face from the pitch, fitted at the studio in Casablanca — the same frames and the same fitting as everyone who walks in.":
      ["Un visage bien connu des terrains, ajusté à l'atelier de Casablanca — les mêmes montures et le même essayage que pour chacun de nos clients.",
       "وجه مألوف من الملاعب، جرى قياس نظارته في أتيليه الدار البيضاء — نفس الإطارات ونفس القياس كأي زائر.",
       "Una cara conocida del césped, ajustada en el taller de Casablanca: las mismas monturas y la misma prueba que cualquiera que entra."],
    "Filmed at the studio, Casablanca": ["Filmé à l'atelier, Casablanca", "صُوِّر في الأتيليه، الدار البيضاء", "Grabado en el taller, Casablanca"],
    ...
    "Continue to details": ["Continuer vers les coordonnées", "متابعة إلى البيانات", "Continuar a los datos"],
    ...
    "Edit details": ["Modifier les coordonnées", "تعديل البيانات", "Editar los datos"],
    ...
    "Thank you. We will call you shortly to confirm your delivery.":
      ["Merci. Nous vous appelons très vite pour confirmer la livraison.",
    ...
    "Send my order on WhatsApp": ["Envoyer ma commande sur WhatsApp", "إرسال طلبي عبر واتساب", "Enviar mi pedido por WhatsApp"],
    "Sending the summary on WhatsApp lets the studio confirm faster.":
      ["Envoyer le récapitulatif sur WhatsApp permet à l'atelier de confirmer plus vite.",
       "إرسال الملخص عبر واتساب يساعد الأتيليه على التأكيد أسرع.",
       "Enviar el resumen por WhatsApp permite al taller confirmar más rápido."],
